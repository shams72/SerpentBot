...
A smart Snake game which uses Breadth-First Search (BFS) algorithm combined with the Manhattan distance heuristic to intelligently hunt down its prey. The snake navigates the game grid with purpose, always finding the next path to its next meal!
